    ...
    return (
        <div className="header">
            <div className="logo-container">
                <img className="logo" src="https://www.logodesign.net/logo/smoking-burger-with-lettuce-3624ld.png?size=2" alt="Food Ordering Logo" />
            </div>
...
const ResturantCard = (props) => {
    ...
    return (
        <div className="resturant-card">
            <img src={"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_264,h_288,c_fill/" + cloudinaryImageId} alt="resturant-logo" className="resturant-logo" />
            <h3>{name}</h3>
            <h4>{cuisines.join(", ")}</h4>
            <h4>{avgRating}</h4>
...
const resList = [
    {
        ...
        "analytics": {
            "context": "seo-data-430283e4-4c5d-4246-8bb2-b00775cd0715"
        },
        "cta": {
    ...
    },
    {
        "info": {
            ...
            "availability": {
                "nextCloseTime": "2024-05-01 16:30:00",
                "opened": true
            },
            "badges": {},
            "isOpen": true,
    ...
    },
    {
        ...
        "cta": {
            "link": "https://www.swiggy.com/restaurants/rajahmundry-ruchulu-venkataramana-colony-kukatpally-hyderabad-709828",
            "text": "RESTAURANT_MENU",
            "type": "WEBLINK"
        },
        "widgetId": "collectionV5RestaurantListWidget_SimRestoRelevance_food_seo"
